...
data_path = os.path.relpath("..\\raw_data_2line.txt", cur_path)
charmap_path = os.path.relpath("..\\unicode.txt", cur_path)
...
# write header to *.csv
with open ("../clean_data_2line.csv", "w", encoding="utf8", newline="") as file_csv:
